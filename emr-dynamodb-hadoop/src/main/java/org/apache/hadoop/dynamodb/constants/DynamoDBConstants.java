...
package org.apache.hadoop.dynamodb.constants;
...
public interface DynamoDBConstants {
    ...
    String DYNAMODB_CREDENTIAL_TYPE = "dynamodb.credential.type";

    String ROLE_ARN_CONF = "aws.assumed.role.arn";
    String SESSION_NAME_CONF = "aws.assumed.role.session.name";
