...
public class MultiKeyQueryReadManager extends AbstractReadManager {

  public MultiKeyQueryReadManager(RateController rateController, AbstractTimeSource time,
  ...
  protected void initializeReadRequests() {
    ...
    for (Integer segment : shuffleSgments) {
      enqueueReadRequestToTail(new MultiKeyQueryRecordReadRequest(this, context, segment, null /*
      lastEvaluatedKey */));
    }
  }
}
