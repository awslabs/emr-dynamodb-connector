...
// copy of same class as org.apache.hadoop.hive.dynamodb.filter for now
public abstract class AbstractDynamoDBFilter implements DynamoDBFilter {

  protected String columnName;
  protected DynamoDBFilterOperator operator;
  protected DynamoDBType columnType;
  protected Condition condition;

  public AbstractDynamoDBFilter(String columnName, DynamoDBFilterOperator operator, DynamoDBType
      columnType) {
  ...
  public String getColumnType() {
    return columnType.getDynamoDBType();
  }
