    ...
    public void configureTableJobProperties(TableDesc tableDesc, Map<String, String> jobProperties) {
        ...
        try {
            ...
            if (description.getBillingModeSummary().getBillingMode().equals(DynamoDBConstants.BILLING_MODE_PROVISIONED)) {
                ...
                jobProperties.put(DynamoDBConstants.READ_THROUGHPUT, tableDesc.getProperties().getProperty(DynamoDBConstants.READ_THROUGHPUT, DynamoDBConstants.DEFAULT_CAPCITY_FOR_ON_DEMAND));
                jobProperties.put(DynamoDBConstants.WRITE_THROUGHPUT, tableDesc.getProperties().getProperty(DynamoDBConstants.WRITE_THROUGHPUT, DynamoDBConstants.DEFAULT_CAPCITY_FOR_ON_DEMAND));
            }
